...
import { AddEmailTemplatesCommandMenuItemCommand } from 'src/database/commands/upgrade-version-command/1-21/1-21-workspace-command-1775500016000-add-email-templates-command-menu-item.command';
...
@Module({
  ...
  providers: [
    ...
    AddEmailTemplatesCommandMenuItemCommand,
  ],
})
